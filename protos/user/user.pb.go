...
var file_user_user_proto_depIdxs = []int32{
	...
	0,  // 1: user.UserResponse.uid:type_name -> user.UserGetterRequest
	...
	0,  // 6: user.UserService.GetUser:input_type -> user.UserGetterRequest
	3,  // 7: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	0,  // 8: user.UserService.DeleteUser:input_type -> user.UserGetterRequest
